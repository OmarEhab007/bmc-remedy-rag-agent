...
public class QualifierBuilder {
    ...
    public QualifierBuilder in(int fieldId, List<String> values) {
        ...
        for (String value : values) {
            orConditions.add(String.format("'%d' = \"%s\"", fieldId, escapeValue(value)));
        }
    ...
    /**
     * Parse a qualification string into a QualifierInfo object.
     * This is required because BMC AR API methods expect QualifierInfo, not String.
     *
     * @param ctx The ARServerUser context
     * @param formName The form name for parsing context
     * @param qualification The qualification string (can be null for all records)
     * @return QualifierInfo object, or null if qualification is null/empty
     * @throws ARException if parsing fails
     */
    public static QualifierInfo parseQualification(ARServerUser ctx, String formName, String qualification) throws ARException {
        if (qualification == null || qualification.trim().isEmpty()) {
            return null;
        }
        return ctx.parseQualification(formName, qualification);
    }
